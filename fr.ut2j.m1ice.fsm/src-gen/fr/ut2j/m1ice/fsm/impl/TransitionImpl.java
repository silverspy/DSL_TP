 ...
 * </p>
 * <ul>
 *   <li>{@link fr.ut2j.m1ice.fsm.impl.TransitionImpl#getSource <em>Source</em>}</li>
 *   <li>{@link fr.ut2j.m1ice.fsm.impl.TransitionImpl#getTarget <em>Target</em>}</li>
		...
		if (source != null && source.eIsProxy()) {
			...
			if (source != oldSource) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FsmPackage.TRANSITION__SOURCE, oldSource,
							source));
			}
		}
		return source;
