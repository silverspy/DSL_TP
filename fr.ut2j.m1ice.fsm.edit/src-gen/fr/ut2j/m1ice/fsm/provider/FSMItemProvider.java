...
/**
 * This is the item provider adapter for a {@link fr.ut2j.m1ice.fsm.FSM} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FSMItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(FsmPackage.Literals.FSM__STATE);
			childrenFeatures.add(FsmPackage.Literals.FSM__TRANSITION);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors
				.add(createChildParameter(FsmPackage.Literals.FSM__STATE, FsmFactory.eINSTANCE.createState()));

		newChildDescriptors
				.add(createChildParameter(FsmPackage.Literals.FSM__STATE, FsmFactory.eINSTANCE.createInitialState()));

		newChildDescriptors
				.add(createChildParameter(FsmPackage.Literals.FSM__STATE, FsmFactory.eINSTANCE.createFinalState()));

		newChildDescriptors.add(
				createChildParameter(FsmPackage.Literals.FSM__TRANSITION, FsmFactory.eINSTANCE.createTransition()));
	}
